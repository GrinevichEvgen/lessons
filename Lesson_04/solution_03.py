"""
Написать функцию xor_cipher, принимающая 2 аргумента - строку и ключ шифрования, которая
возвращает строку, зашифрованную путем применения функции XOR (^) над символами строки с ключом.
...
print(f"Зашифрованное сообщение: {printable_encrypted_string(encrypted_string)}")

decrypted_string = xor_cipher(encrypted_string, encryption_key)
print(f"Расшифрованное сообщение: {decrypted_string}")