'''Создать программу с пользовательским интерфейсом позволяющим выбирать
определенную функцию и вводить необходимые данные.'''

from solution_01 import create_product_table, get_products, create_product, update_product, delete_product
